...
namespace EF_Core
{
    public class EShopContext : IdentityDbContext<User>
    {
        ...
        //{
        //    optionsBuilder.UseLazyLoadingProxies().UseSqlServer("Data source = DESKTOP-OIVVN7J; Initial catalog = E-Shopp; Integrated security= true; trustservercertificate = true;MultipleActiveResultSets=True");
