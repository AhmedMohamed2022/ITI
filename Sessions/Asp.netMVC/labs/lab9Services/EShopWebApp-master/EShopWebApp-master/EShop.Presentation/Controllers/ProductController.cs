...
namespace EShop.Presentation.Controllers
{
    ...
    public class ProductController : Controller
    {
        ...
        public IActionResult VendorList(string searchText = "", decimal price = 0, int categoryId = 0, int pageNumber = 1, int pageSize = 3)
        {
        ...
        public IActionResult ClientList(string searchText = "", decimal price = 0, int categoryId = 0, int pageNumber = 1,int pageSize = 3)
        {
