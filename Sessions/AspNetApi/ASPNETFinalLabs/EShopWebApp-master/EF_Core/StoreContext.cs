...
namespace EF_Core
{
    public class EShopContext : IdentityDbContext<User>
    {
        ...
        //{
        //    optionsBuilder.UseLazyLoadingProxies().UseSqlServer("Data source = localhost\\SQL2022; Initial catalog = E-ShoppApi; Integrated security = true; trustservercertificate = true; MultipleActiveResultSets = True");
